...
public class Particle implements Scrollable
{
	...
	public void draw(Graphics2D g, int offset) //Draws the particle's image if it exists, otherwise draws a circle
	{
		if (i == null)
		{
			g.setColor(c);
			...
			g.drawImage(i, x,  y, DIAMETER*3, DIAMETER*3, null);
	}
